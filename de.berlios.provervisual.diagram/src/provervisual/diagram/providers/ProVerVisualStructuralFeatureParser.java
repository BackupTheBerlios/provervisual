 ...
 * @generated
 */
public class ProVerVisualStructuralFeatureParser extends
		ProVerVisualAbstractParser {
	 ...
	 * @generated
	 */
	public ProVerVisualStructuralFeatureParser(EStructuralFeature feature) {
	...
	protected IParserEditStatus validateValues(Object[] values) {
		...
		if (value instanceof InvalidValue) {
			return new ParserEditStatus(ProVerVisualDiagramEditorPlugin.ID,
