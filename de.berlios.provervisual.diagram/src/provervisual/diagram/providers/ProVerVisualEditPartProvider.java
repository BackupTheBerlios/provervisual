 ...
 * @generated
 */
public class ProVerVisualEditPartProvider extends AbstractEditPartProvider {
	 ...
	 * @generated
	 */
	public ProVerVisualEditPartProvider() {
		setFactory(new ProVerVisualEditPartFactory());
