 ...
 * @generated
 */
public class ProVerVisualDiagramEditorUtil extends IDEEditorUtil {
	...
	public static final IFile createAndOpenDiagram(
		...
		IFile diagramFile = ProVerVisualDiagramEditorUtil.createNewDiagramFile(
	...
	public static final IFile createNewDiagramFile(
		...
		IPath modelFileRelativePath = diagramFile.getFullPath()
				.removeFileExtension().addFileExtension("provervisual"); //$NON-NLS-1$
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
			...
			protected CommandResult doExecuteWithResult(
				...
				EObject model = ProvervisualFactory.eINSTANCE
						.create(ProvervisualPackage.eINSTANCE.getProtocol());
