 ...
 * @generated
 */
public class Operation_operationAbbrev2EditPart extends LabelEditPart implements
		ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(Operation_operationAbbrev2EditPart.VISUAL_ID,
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public Operation_operationAbbrev2EditPart(View view) {
		super(view);
	}
				...
				ParserHintAdapter hintAdapter = new ParserHintAdapter(element,
					...
					public Object getAdapter(Class adapter) {
						if (IElementType.class.equals(adapter)) {
							return ProVerVisualElementTypes.Operation_3001;
						}
	...
	protected IFigure createFigurePrim() {
		return new OperationOperationAbbrevFigure();
	}

	/**
	 * @generated
	 */
	public class OperationOperationAbbrevFigure extends
			org.eclipse.gmf.runtime.draw2d.ui.figures.WrapLabel {

		/**
		 * @generated
		 */
		public OperationOperationAbbrevFigure() {
