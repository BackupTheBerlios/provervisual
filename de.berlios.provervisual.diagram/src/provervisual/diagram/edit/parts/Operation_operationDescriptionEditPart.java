 ...
 * @generated
 */
public class Operation_operationDescriptionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public Operation_operationDescriptionEditPart(View view) {
		super(view);
	}
	...
	protected Image getLabelIcon() {
		...
		ImageDescriptor descriptor = ProVerVisualDiagramEditorPlugin
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof ProVerVisualTextSelectionEditPolicy) {
			((ProVerVisualTextSelectionEditPolicy) pdEditPolicy)
					.refreshFeedback();
		}
	}
				...
				ParserHintAdapter hintAdapter = new ParserHintAdapter(element,
					...
					public Object getAdapter(Class adapter) {
						if (IElementType.class.equals(adapter)) {
							return ProVerVisualElementTypes.Operation_1004;
						}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), ProVerVisualEditPartFactory
	...
	protected IFigure createFigurePrim() {
		return new OperationOperationDescriptionFigure();
	}

	/**
	 * @generated
	 */
	public class OperationOperationDescriptionFigure extends
			org.eclipse.gmf.runtime.draw2d.ui.figures.WrapLabel {

		/**
		 * @generated
		 */
		public OperationOperationDescriptionFigure() {
