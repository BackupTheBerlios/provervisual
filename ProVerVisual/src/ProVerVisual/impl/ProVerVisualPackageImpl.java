 ...
 * </copyright>
 *
 * $Id: ProVerVisualPackageImpl.java,v 1.1 2006/04/10 06:02:39 rustikus Exp $
 */
...
public class ProVerVisualPackageImpl extends EPackageImpl implements ProVerVisualPackage {
	 ...
	 * @generated
	 */
	public EReference getProtocol_ProtocolState() {
	 ...
	 * @generated
	 */
	public EReference getProtocol_ProtocolTransition() {
	...
	public void createPackageContents() {
		...
		createEReference(protocolEClass, PROTOCOL__PROTOCOL_STATE);
		createEReference(protocolEClass, PROTOCOL__PROTOCOL_TRANSITION);
	...
	public void initializePackageContents() {
		...
		branchEClass.getESuperTypes().add(this.getState());
		...
		initEReference(getProtocol_ProtocolState(), this.getState(), null, "protocolState", null, 0, -1, Protocol.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProtocol_ProtocolTransition(), this.getTransition(), null, "protocolTransition", null, 0, -1, Protocol.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
