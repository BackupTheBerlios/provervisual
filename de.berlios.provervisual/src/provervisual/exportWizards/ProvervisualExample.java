 ...
 * </copyright>
 *
 * $Id: ProvervisualExample.java,v 1.1 2006/04/25 08:48:40 rustikus Exp $
 */
...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>provervisual</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ProvervisualExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.provervisual"));
    ...
    protected static void printProtocol(Protocol protocol){
            
            StringBuffer output = new StringBuffer();
            String test = protocol.getName() != null ? "Protocol Name: "+protocol.getName() : "Protocol Name not specified";
            output.append(test+"\n");
            output.append("Protocol Type: "+protocol.getType()+"\n");
            test = protocol.getDescription() != null ? "Protocol Description: "+protocol.getDescription() : "No Description available";
            output.append(test+"\n");
